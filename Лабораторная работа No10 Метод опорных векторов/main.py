...
# Обучение и визуализация модели LinearSVC
...
# Добавление нового признака и визуализация в 3D
...
# Обучение и визуализация модели LinearSVC в 3D
...
# Визуализация границы решения SVM с ядром RBF
...
# Визуализация влияния параметров C и gamma в SVM
...
# Пример использования SVC на наборе данных cancer
...
# Визуализация диапазона значений признаков
...
# Масштабирование признаков и повторное обучение модели
