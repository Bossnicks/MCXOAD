...
print("Правильность на обучающем наборе (C=0.01): {:.3f}".format(logreg001.score(X_train, y_train)))
print("Правильность на тестовом наборе (C=0.01): {:.3f}".format(logreg001.score(X_test, y_test)))
